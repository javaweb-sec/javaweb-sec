...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20191203163038813.png)

`java.io.FileSystem`是一个抽象类，它抽象了对文件的操作，不同操作系统版本的JDK会实现其抽象的方法从而也就实现了跨平台的文件的访问操作。

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20191203164105238.png)

示例中的`java.io.UnixFileSystem`最终会通过JNI调用native方法来实现对文件的操作:

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20191203164635637.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20191203181206243.png)
