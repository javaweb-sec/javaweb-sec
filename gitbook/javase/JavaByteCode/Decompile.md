...
<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019142922249.png" alt="image-20201019142922249" style="zoom:50%;" />

`JD-GUI`支持批量反编译，在菜单中点击`File`-->`Save All Sources`即可反编译整个jar文件，如下图：

<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019152122562.png" alt="image-20201019152122562" style="zoom:50%;" />
...
<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019140224424.png" alt="image-20201019140224424" style="zoom:50%;" />
...
<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019135811893.png" alt="image-20201019135811893" style="zoom:50%;" />

字节码编辑：

<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019135923429.png" alt="image-20201019135923429" style="zoom:50%;" />
...
<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019142224784.png" alt="image-20201019142224784" style="zoom:50%;" />

`attach`模式可附加`Recaf`到一个指定的JVM进程：

<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019140022294.png" alt="image-20201019140022294" style="zoom:50%;" />
...
<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019143255436.png" alt="image-20201019143255436" style="zoom:50%;" />

字符串搜索测试：

<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019143217542.png" alt="image-20201019143217542" style="zoom:40%;" />
...
<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/4.2.png" alt="4.2" style="zoom:50%;" />
...
<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019143701601.png" alt="image-20201019143701601" style="zoom:50%;" />
...
<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019145310008.png" alt="image-20201019145310008" style="zoom:40%;" />
...
<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019154032388.png" alt="image-20201019154032388" style="zoom:50%;" />
...
<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019160840290.png" alt="image-20201019160840290" style="zoom: 40%;" />
...
<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019164255758.png" alt="image-20201019164255758" style="zoom:50%;" />

### 删除常量池对象

<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019164424942.png" alt="image-20201019164424942" style="zoom:50%;" />

### 删除类成员变量

<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019164800876.png" alt="image-20201019164800876" style="zoom:50%;" />

### 查看字节码

<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019164619458.png" alt="image-20201019164619458" style="zoom:50%;" />
...
<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019164705299.png" alt="image-20201019164705299" style="zoom:50%;" />
...
<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019170935681.png" alt="image-20201019170935681" style="zoom:50%;" />
...
<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019173646644.png" alt="image-20201019173646644" style="zoom:50%;" />

### 字节码编辑

<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019173107619.png" alt="image-20201019173107619" style="zoom:50%;" />

### 字节码分析

<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019174255460.png" alt="image-20201019174255460" style="zoom:50%;" />

### 方法信息编辑

<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019173815788.png" alt="image-20201019173815788" style="zoom:50%;" />

### 方法添加/编辑

<img src="https://javasec.oss-cn-hongkong.aliyuncs.com/images/image-20201019173247265.png" alt="image-20201019173247265" style="zoom:50%;" />
