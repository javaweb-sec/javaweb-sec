...
最近学习研究一下目前业内主流的 JavaWeb 内存马实现方式，并探究完美的查和杀的方法。
...
![](../../images/1625284866775.png)

访问添加 filter。

![](../../images/1625284866777.png)

再次访问，id 参数会被加三。

![](../../images/1625284866778.png)
...
![](../../images/1625284866782.png)

看一下效果。

![](../../images/1625284866783.png)
...
![](../../images/1625284866793.png)

添加 Listener，可以看到，由于我们是在 requestDestroyed 中植入恶意逻辑，那么在本次请求中就已经生效了：

![](../../images/1625284866794.png)

访问之前的路径也生效了：

![](../../images/1625284866796.png)
...
![](../../images/1625284866807.png)

这里我们看到，是调用了 MappingRegistry 的 register 方法，这个方法将一些关键信息进行包装、处理和储存。

![](../../images/1625284866809.png)

关键信息储存位置如下：

![](../../images/1625284866811.png)
...
![](../../images/1625284866814.png)

动态添加 Controller

![](../../images/1625284866817.png)

访问添加的 Controller

![](../../images/1625284866818.png)
...
![](../../images/1625284866820.png)

添加拦截器

![](../../images/1625284866821.png)

再次访问

![](../../images/1625284866822.png)
...
![](../../images/1625284866826.png)

`org.apache.catalina.Valve` 的定义如下：

![](../../images/1625284866829.png)
...
![](../../images/1625284866835.png)

动态添加自定义恶意 Valve，会先调用 response 写入字符串

![](../../images/1625284866836.png)

再次访问出现效果：

![](../../images/1625284866838.png)
...
![](../../images/1625284866850.png)

attach 测试使用的 agent：

![](../../images/1625284866852.png)

再次访问：

![](../../images/1625284866854.png)
...
![](../../images/1625284866855.png)

![](../../images/1625284866859.png)
