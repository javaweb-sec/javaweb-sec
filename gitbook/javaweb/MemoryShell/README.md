...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623378669097.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623383074795.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623412713625.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623553440934.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623566822352.png)

在 ApplicationFilterRegistration 的 `addMappingForUrlPatterns` 中生成了 filterMaps。

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623566974104.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623559164607.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623565922927.png)

访问添加 filter。

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623565973421.png)

再次访问，id 参数会被加三。

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623566012255.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623571128390.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623575000562.png)

看一下效果。

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623574985705.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623576978964.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623578410672.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623640456652.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623641922533.png)

添加 Listener，可以看到，由于我们是在 requestDestroyed 中植入恶意逻辑，那么在本次请求中就已经生效了：

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623641951941.png)

访问之前的路径也生效了：

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623642002784.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623734468541.png)

这个方法调用了 initHandlerMethods 方法，首先获取了 Spring 中注册的 Bean，然后循环遍历，调用 `processCandidateBean` 方法处理 Bean。

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623735423292.png)

`processCandidateBean` 方法

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623735638214.png)

`isHandler` 方法判断当前 bean 定义是否带有 Controller 或 RequestMapping 注解。

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623735310283.png)

`detectHandlerMethods` 查找 handler methods 并注册。

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623735988861.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623736666146.png)

这里我们看到，是调用了 MappingRegistry 的 register 方法，这个方法将一些关键信息进行包装、处理和储存。

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623736616923.png)

关键信息储存位置如下：

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623736988351.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623757300676.png)

动态添加 Controller

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623757305546.png)

访问添加的 Controller

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623757310626.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623808912048.png)

添加拦截器

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623808919546.png)

再次访问

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623808925115.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623645442719.jpg)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623646288477.png)

`org.apache.catalina.Valve` 的定义如下：

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623646342704.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623647163683.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623648233517.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623649463332.png)

动态添加自定义恶意 Valve，会先调用 response 写入字符串

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623649411692.png)

再次访问出现效果：

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623649401840.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1624019245038.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623823221923.png)

使用 javassist 在其中插入了自己的判断逻辑，也就是项目的 ReadMe 中 usage 中提供的一些逻辑，

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623824044934.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623829223756.png)

agent 端在 net/rebeyond/behinder/resource/tools 中，应该是根据不同的类型会上传不同的注入包。

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623826322201.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623828945298.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623933746321.png)

attach 测试使用的 agent：

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623933780013.png)

再次访问：

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1623933791544.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1624411677855.png)

![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1624411684573.png)
...
![img](https://javasec.oss-cn-hongkong.aliyuncs.com/images/1624522943976.png)
...
[![Memory Shell Test](https://javasec.oss-cn-hongkong.aliyuncs.com/images/youtube--tTFv15uCNjQ-c05b58ac6eb4c4700831b2b3070cd403.jpg)](https://youtu.be/tTFv15uCNjQ)
