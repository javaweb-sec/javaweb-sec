...
![](../../images/1625284296406.png)

然后调用 `getValue()` 方法实际上就是 `Ognl.getValue()` 方法解析字符串。

![](../../images/1625284296408.png)
...
![](../../images/1625284296423.png)

模板引入了 struts/webconsole.html ，我们也可以直接访问这个路径来访问这个页面

![](../../images/1625284296426.png)

![](../../images/1625284296428.png)
