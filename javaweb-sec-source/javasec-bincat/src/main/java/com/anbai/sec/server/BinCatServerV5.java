 ...
 */
public class BinCatServerV5 {

	// 设置服务监听端口
	private static final int PORT = 8080;

	// 设置服务名称
	private static final String SERVER_NAME = "BinCat-0.0.5";
	...
	public static void main(String[] args) {
		try {
			...
			BinCatServletContext servletContext = BinCatConfig.createServletContext(appClassLoader);

			// 启动Web应用
			BinCatConfig.startWebApp(servletContext);
