...
//
//public class RASPClassFileReflectionTransformer implements ClassFileTransformer {
//
//	private final Set<RASPClassHookConfig> hookConfigs;
//
//	public RASPClassFileReflectionTransformer(Set<RASPClassHookConfig> hookConfigs) {
...
//				}
//
//				loadClass.append("ClassLoader loader = ClassLoader.getSystemClassLoader();")
//						.append("Class proxyClass = loader.loadClass(\"com.anbai.sec.rasp.commons.RASPHookProxy\");");
//
//				invokeResult.append("Class resultClass = result.getClass();")
//						.append("String handlerType = resultClass.getMethod(\"getRaspHookHandlerType\", new Class[0]).invoke(result, new Object[0]).toString();")
//						.append("if (\"REPLACE_OR_BLOCK\".equals(handlerType)) {");
//
//				// 处理普通方法和构造方法的返回值
...
//					} else {
//						// 强制类型转换
//						invokeResult.append("return (").append(returnType.getSimpleName()).append(")resultClass.getMethod(\"getReturnValue\", new Class[0]).invoke(result, new Object[0]);");
//					}
//				} else {
...
//						.append("   throw (Exception) resultClass.getMethod(\"getException\", new Class[0]).invoke(result, new Object[0]);")
//						.append("}");
//
//				String before = "java.lang.reflect.Method method = proxyClass.getMethod(\"onMethodEnter\", new Class[]{Object[].class, String.class, String.class, String.class, String.class, Object.class});" +
//						"Object result = method.invoke(null, new Object[]{$args, \"" + callbackClass + "\", \"" + className + "\", \"" + methodName + "\", \"" + signature + "\", $0});";
//
//				String after = "java.lang.reflect.Method method = proxyClass.getMethod(\"onMethodExit\", new Class[]{Object.class, Object[].class, String.class, String.class, String.class, String.class, Object.class});" +
//						"Object result = method.invoke(null, new Object[]{$_, $args, \"" + callbackClass + "\", \"" + className + "\", \"" + methodName + "\", \"" + signature + "\", $0});";
//
//				if (superClassHook) {
//					invokeResult.append("}");
//				}
//
//				onMethodEnter.append(loadClass).append(before);
//				onMethodExit.append(loadClass).append(after);
//
//				break;
//			}
//
